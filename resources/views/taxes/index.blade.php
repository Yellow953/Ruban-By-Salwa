...
@section('actions')
<a class="btn btn-success btn-sm px-4" href="{{ route('taxes.new') }}">
    <i class="fa-solid fa-plus"></i>
    <span class="d-none d-md-inline">New Tax</span>
</a>
<a class="btn btn-primary btn-sm px-4" href="{{ route('taxes.pdf', request()->query()) }}">
    <i class="fa-solid fa-file-pdf"></i>
    <span class="d-none d-md-inline">Export to PDF</span>
</a>
<a class="btn btn-primary btn-sm px-4" href="{{ route('taxes.export', request()->query()) }}">
