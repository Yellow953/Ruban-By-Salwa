...
<div class="container mt-5">
    <div class="card border-custom">
        <form action="{{ route('taxes.update', $tax->id) }}" method="POST" enctype="multipart/form-data" class="form">
            @csrf
            <div class="card-head">
                <h1 class="text-center text-primary">Edit Tax</h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="rate" placeholder="Enter Rate..." step="any"
                                min="0" max="100" value="{{ $tax->rate }}" required />
                        </div>
                    </div>
                </div>
            </div>
