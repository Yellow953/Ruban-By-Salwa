...
<head>
    <title>Ruban By Salwa | Report #{{ $report->id }}</title>
    <meta charset="utf-8">
                                    ...
                                    <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                                        <div>
                                            ...
                                            <div class="flex-root d-flex flex-column mt-4">
                                                ...
                                                <span class="fs-5">
                                                    {{ $report->start_datetime->format('Y-m-d H:i') }} to
                                                    {{ $report->end_datetime->format('Y-m-d H:i') }}
                                                </span>
                                            </div>
                                            <div class="flex-root d-flex flex-column mt-4">
                                                <span class="text-muted fw-bold">Generated By</span>
                                                <span class="fs-5">{{ $report->user->name }}</span>
                                            </div>
                                            <div class="flex-root d-flex flex-column mt-4">
                                                <span class="text-muted fw-bold">Date Generated</span>
                                                <span class="fs-5">{{ $report->created_at->format('Y-m-d H:i') }}</span>
                                            </div>
                                        </div>
                                        <!--end::Logo-->
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody class="fw-semibold text-gray-600">
                                                            ...
                                                            <tr>
                                                                <td>Total Tax</td>
                                                                <td class="text-end">{{ $report->currency->symbol }}{{
                                                                    number_format($report->total_tax, 2) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Total Discounts</td>
                                                                <td class="text-end">{{ $report->currency->symbol }}{{
                                                                    number_format($report->total_discounts, 2) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Cash Payments</td>
                                                                <td class="text-end">{{ $report->currency->symbol }}{{
                                                                    number_format($report->cash_amount, 2) }}</td>
                                                            </tr>
                                                            <tr class="text-dark fw-bold">
                                                                <td>Net Sales</td>
                                                                <td class="text-end">{{ $report->currency->symbol }}{{
                                                                    number_format($report->total_sales -
                                                                    $report->total_discounts, 2) }}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
