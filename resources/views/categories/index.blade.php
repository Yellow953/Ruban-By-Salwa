...
<a class="btn btn-primary btn-sm px-4" href="{{ route('categories.pdf', request()->query()) }}">
    <i class="fa-solid fa-file-pdf"></i>
    <span class="d-none d-md-inline">Export to PDF</span>
</a>
<a class="btn btn-primary btn-sm px-4" href="{{ route('categories.export', request()->query()) }}">
