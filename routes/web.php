...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['verified'])->group(function () {
        ...
        Route::post('/setup', [ProfileController::class, 'setup_save'])->name('setup.save');

        // Invalid  Subscirption
        Route::get('/subscriptions/invalid', [SubscriptionController::class, 'invalid'])->name('subscriptions.invalid');
        ...
        Route::prefix('app')->group(function () {
            ...
            Route::middleware(['super admin'])->group(function () {
                ...
                Route::prefix('taxes')->group(function () {
                    ...
                    Route::get('/pdf', [TaxController::class, 'pdf'])->name('taxes.pdf');
                ...
                Route::prefix('businesses')->group(function () {
                    ...
                    Route::get('/pdf', [BusinessController::class, 'pdf'])->name('businesses.pdf');
                    ...
                    Route::get('/{business}/delete', [BusinessController::class, 'destroy'])->name('businesses.destroy');
                    Route::get('/{business}/users', [BusinessController::class, 'users'])->name('businesses.users');
                    Route::post('/{business}/users/create', [BusinessController::class, 'users_create'])->name('businesses.users.create');
                ...
                Route::prefix('subscriptions')->group(function () {
                    ...
                    Route::get('/pdf', [SubscriptionController::class, 'pdf'])->name('subscriptions.pdf');
                    Route::get('/new', [SubscriptionController::class, 'new'])->name('subscriptions.new');
                    ...
                    Route::get('/{subscription}/delete', [SubscriptionController::class, 'destroy'])->name('subscriptions.destroy');
                    Route::get('/', [SubscriptionController::class, 'index'])->name('subscriptions');
                });

                Route::get('/clean', [SuperAdminController::class, 'clean'])->name('clean');
                Route::get('/optimize', [SuperAdminController::class, 'optimize'])->name('optimize');
            });

            // Admin, User
            Route::middleware(['setup', 'subscription'])->group(function () {
                // Switch Currency
                ...
                Route::prefix('business')->group(function () {
                    ...
                    Route::post('/delivery/update', [ProfileController::class, 'delivery_update'])->name('business.delivery.update');
                ...
                Route::prefix('tables')->group(function () {
                    Route::get('/export', [TableController::class, 'export'])->name('tables.export');
                    Route::get('/pdf', [TableController::class, 'pdf'])->name('tables.pdf');
                    Route::get('/new', [TableController::class, 'new'])->name('tables.new');
                    Route::post('/create', [TableController::class, 'create'])->name('tables.create');
                    ...
                    Route::get('/{table}/delete', [TableController::class, 'destroy'])->name('tables.destroy');
                    Route::get('/', [TableController::class, 'index'])->name('tables');
                });

                // Reservations Routes
                Route::prefix('reservations')->group(function () {
                    Route::get('/export', [ReservationController::class, 'export'])->name('reservations.export');
                    Route::get('/pdf', [ReservationController::class, 'pdf'])->name('reservations.pdf');
                    Route::get('/new', [ReservationController::class, 'new'])->name('reservations.new');
                    Route::post('/create', [ReservationController::class, 'create'])->name('reservations.create');
                    ...
                    Route::get('/{reservation}/delete', [ReservationController::class, 'destroy'])->name('reservations.destroy');
...
// Menu
Route::get('/{business:name}/menu', [HomeController::class, 'menu'])->name('menu');
Route::get('/{business:name}/checkout', [HomeController::class, 'checkout'])->name('menu.checkout');
Route::get('/qrcode/{business}/download', [HomeController::class, 'qrcode_download'])->name('qrcode.download');
